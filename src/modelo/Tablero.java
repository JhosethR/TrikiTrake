...
public class Tablero extends JPanel{
    ...
    public void cambiarEstilos(TipoImagen jugadorAct){
        if(jugadorAct==TipoImagen.CIRCULO){
            FormTrikiTrake.imgJugadorEquis.setRuta(Ruta.JUGADORAUXILLAR);
            FormTrikiTrake.imgJugadorEquis.repaint();
            FormTrikiTrake.nameJugadorEquis.setForeground(new Color(240,240,240,100));
            
            FormTrikiTrake.imgJugadorCirculo.setRuta(Ruta.JUGADORCIRCULO);
            FormTrikiTrake.imgJugadorCirculo.repaint();
            FormTrikiTrake.nameJugadorCirculo.setForeground(new Color(255,200,255));
        }else if(jugadorAct==TipoImagen.EQUIS){
            FormTrikiTrake.imgJugadorCirculo.setRuta(Ruta.JUGADORAUXILLAR);
            FormTrikiTrake.imgJugadorCirculo.repaint();
            FormTrikiTrake.nameJugadorCirculo.setForeground(new Color(240,240,240,100));
            
            FormTrikiTrake.imgJugadorEquis.setRuta(Ruta.JUGADOREQUIS);
            FormTrikiTrake.imgJugadorEquis.repaint();
            FormTrikiTrake.nameJugadorEquis.setForeground(new Color(180,232,255));
        }
    }
    ...
    public void reiniciarTablero(TipoImagen ganador){
        ...
        if(ganador==TipoImagen.EQUIS){
            int puntajeNuevo= Integer.parseInt(FormTrikiTrake.puntajeEquis.getText())+1;
            FormTrikiTrake.puntajeEquis.setText(String.valueOf(puntajeNuevo));
        }
        else if(ganador==TipoImagen.CIRCULO){
             int puntajeNuevo= Integer.parseInt(FormTrikiTrake.puntajeCirculo.getText())+1;
            FormTrikiTrake.puntajeCirculo.setText(String.valueOf(puntajeNuevo));
        }
