...
public class FormTrikiTrake extends javax.swing.JFrame {
    
    public static Imagen imgJugadorEquis;
    public static Imagen imgJugadorCirculo;
    public static JLabel nameJugadorEquis;
    public static JLabel nameJugadorCirculo;
    ...
    public FormTrikiTrake(Jugador jugador1,Jugador jugador2) {
        this.jugador1 = jugador1;
        this.jugador2 = jugador2;
        init();
        imgJugadorEquis = jugadorEquis;
        imgJugadorCirculo = jugadorCirculo;
        nameJugadorEquis = lblNombreJ1;
        nameJugadorCirculo = lblNombreJ2;
